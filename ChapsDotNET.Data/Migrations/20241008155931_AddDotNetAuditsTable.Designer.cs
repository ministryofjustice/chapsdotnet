...
namespace ChapsDotNET.Data.Migrations
{
    ...
    [Migration("20241008155931_AddDotNetAuditsTable")]
    partial class AddDotNetAuditsTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChapsDotNET.Data.Entities.Alert", b =>
                {
                    ...
                    b.Property<int>("RaisedHours")
                        .HasColumnType("int");

                    b.Property<DateTime>("WarnStart")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("ChapsDotNET.Data.Entities.Campaign", b =>
                {
            ...
            modelBuilder.Entity("ChapsDotNET.Data.Entities.CorrespondenceTypesByTeam", b =>
                {
                    ...
                    b.HasKey("CorrespondenceTypeID", "TeamID");

                    b.HasIndex("TeamID");

                    b.ToTable("CorrespondenceTypesByTeams");
                });
