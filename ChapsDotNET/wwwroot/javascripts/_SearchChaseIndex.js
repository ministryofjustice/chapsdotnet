    ...
    function resetSection(name) {
        switch (name) {
            case "Item":
                ...
                $('#AdviceByDateSearch').prop('selectedIndex', 0).trigger('change');
                $('#DateReceivedSearch').prop('selectedIndex', 0).trigger('change');
                $('#LetterDateSearch').prop('selectedIndex', 0).trigger('change');
                $('#SentDateSearch').prop('selectedIndex', 0).trigger('change');
                $('#SentPODateSearch').prop('selectedIndex', 0).trigger('change');
                $('#ReturnedPODateSearch').prop('selectedIndex', 0).trigger('change');
                ...
                $('#PolicyID').prop('selectedIndex', 0);
                $('#MinisterID').prop('selectedIndex', 0);
                $('#DivisionBranchID').prop('selectedIndex', 0);
                $('#Summary').val('');
                $('#OriginalAddressee').val('');
                $('#ResponseReceivedFrom').val('');
                $('#ResponseSentTo').val('');
                $('#ResponseCopiedTo').val('');
                $('#RequestID').val('0');
                $('#DepartmentCompany').val('');
                $('#StatusID').prop('selectedIndex', 0);
                $('#CategoryID').prop('selectedIndex', 0).trigger('change');
                $('#itemCount').text('(0/19)');
                break;
            case "Correspondent":
